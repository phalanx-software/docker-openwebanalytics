...
define('OWA_PUBLIC_URL', getenv('OWA_PUBLIC_URL') ?: 'http://localhost:8080/');
...
define('OWA_ERROR_HANDLER', getenv('OWA_ERROR_HANDLER') ?: 'production');
...
define('OWA_LOG_PHP_ERRORS', getenv('OWA_LOG_PHP_ERRORS') ?: false);
...
define('OWA_CACHE_OBJECTS', getenv('OWA_CACHE_OBJECTS') ?: true);
